    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <span className="px-2.5 py-1 rounded-full text-2xs font-semibold uppercase tracking-wide bg-purple-500/10 text-purple-400 border border-purple-500/20">
        ...
        {/* Status Badge */}
        {isComplete ? (
          <span className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-green-500/10 text-green-400 text-2xs font-semibold border border-green-500/20">
          ...
          <span className="px-2.5 py-1 rounded-full bg-amber-500/10 text-amber-400 text-2xs font-semibold border border-amber-500/20">
