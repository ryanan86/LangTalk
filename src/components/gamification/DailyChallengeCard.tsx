  ...
  return (
    <div
      className={`
        ...
        ${isComplete ? 'ring-2 ring-green-400/30' : ''}
        ${className}
      `}
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <span className="px-2.5 py-1 rounded-full text-2xs font-semibold uppercase tracking-wide bg-violet-500/10 text-violet-600 dark:text-violet-400 border border-violet-500/20">
        ...
        {/* Status Badge */}
        {isComplete ? (
          <span className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-green-500/10 text-green-600 dark:text-green-400 text-2xs font-semibold border border-green-500/20">
          ...
          <span className="px-2.5 py-1 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 text-2xs font-semibold border border-amber-500/20">
        ...
        {!isComplete && (
          <div className="flex items-center gap-2">
            <div className="w-20 h-1.5 rounded-full bg-neutral-200 dark:bg-white/10 overflow-hidden">
              <div className="h-full rounded-full bg-gradient-to-r from-violet-600 to-indigo-500 w-0 transition-all duration-500" />
            </div>
          </div>
        )}
