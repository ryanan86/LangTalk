    ...
    <>
      ...
      <div data-report-section className={`${sectionBg} p-4 space-y-4`}>
            ...
            return (
              <div key={metric.label} className={`report-glass rounded-2xl p-3 flex items-center gap-3 report-fade-up report-fade-up-${idx + 1}`}>
                ...
                <div className="min-w-0 flex-1">
                  <p className="dark:text-slate-400 text-zinc-500 text-xs leading-tight truncate">{metric.label}</p>
                  <p className="dark:text-white text-zinc-900 font-bold text-sm">{metric.value}</p>
                </div>
              </div>
            );
          })}
        ...
        <div className="rounded-2xl report-glass p-4 sm:p-5">
          <h4 className="text-sm sm:text-base font-semibold dark:text-white text-zinc-900 mb-3 flex items-center gap-2">
          ...
          <p className="text-center dark:text-slate-500 text-zinc-400 text-[10px] sm:text-xs">
              ...
              {strengths.map((m) => (
                <div key={m.label} className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-medium dark:text-white text-zinc-900 leading-tight">{m.label}</p>
                    <p className="text-[10px] dark:text-slate-400 text-zinc-500">{m.value}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <div data-report-section className={`${sectionBg} p-4 space-y-4`}>
        {/* Detailed Metrics */}
        <div className="rounded-2xl report-glass p-4 sm:p-5">
          <h4 className="text-sm sm:text-base font-semibold dark:text-white text-zinc-900 mb-4 flex items-center gap-2">
            ...
            {metrics.map((metric) => (
              <div key={metric.label}>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs sm:text-sm dark:text-slate-300 text-zinc-600">{metric.label}</span>
                  <div className="flex items-center gap-1.5">
                    <span className="text-xs sm:text-sm font-semibold dark:text-white text-zinc-900">{metric.value}</span>
                ...
                <div className="h-2 dark:bg-white/[0.04] bg-black/[0.03] rounded-full overflow-hidden">
                  <div
        ...
        <div className="grid grid-cols-3 gap-2.5">
          {[
            ...
            <div key={stat.label} className="rounded-2xl report-glass p-3.5 text-center">
              <div className="w-9 h-9 rounded-xl dark:bg-white/[0.04] bg-black/[0.03] flex items-center justify-center mx-auto mb-2">
                <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={stat.icon} />
                </svg>
              </div>
              <p className="text-xl sm:text-2xl font-bold dark:text-white text-zinc-900 mb-0.5">{stat.value}</p>
              <p className="text-[10px] dark:text-slate-500 text-zinc-400">{stat.label}</p>
            </div>
          ))}
        </div>
        ...
        <div className="rounded-2xl bg-purple-500/[0.05] border border-purple-500/[0.08] report-glass p-4 sm:p-5">
          <h4 className="text-sm font-semibold dark:text-white text-zinc-900 mb-3 flex items-center gap-2">
