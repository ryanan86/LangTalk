              ...
              {status === 'loading' ? (
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white text-black font-medium hover:bg-white/90 transition-all hover:scale-105"
                    title="Google 로그인"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-xl bg-[#FEE500] text-[#191919] font-medium hover:bg-[#FDD800] transition-all hover:scale-105"
                    title="카카오 로그인"
                  >
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
