            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              {session && isSubscribed && (
                <div className="max-w-2xl mx-auto mb-4 px-4">
                  <a
                    href="/exam"
                    className="flex items-center justify-between gap-3 w-full px-4 py-3 rounded-2xl border border-theme bg-surface hover:bg-surface-hover transition-all hover:shadow-md group"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <p className="text-sm font-semibold text-theme-primary">시험 모드</p>
                        <p className="text-xs text-theme-muted">토스 / 오픽 예상 등급</p>
                      </div>
                    </div>
                    <svg className="w-4 h-4 text-theme-muted group-hover:text-theme-secondary transition-colors shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
