    ...
    <div className="min-h-screen bg-gray-100 dark:bg-[#0a0a0f] text-neutral-900 dark:text-white overflow-hidden">
      ...
      <footer className="relative z-10 py-8 border-t border-neutral-200 dark:border-white/5">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center space-y-4">
          {/* Contact Button - KakaoTalk for Korean, WhatsApp for others */}
          <div>
            {language === 'ko' ? (
              <a
                href="https://pf.kakao.com/_taptalk"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#FEE500] text-[#3C1E1E] text-sm font-medium hover:bg-[#FDD800] transition-all"
              >
