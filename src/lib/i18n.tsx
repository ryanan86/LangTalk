...
const translations: Record<Language, Translations> = {
  ko: {
    ...
    // Talk page
    readyToStart: '{name}님과 대화할 준비가 되셨나요?',
  ...
  en: {
    ...
    // Talk page
    readyToStart: 'Ready to practice with {name}',
  ...
  nl: {
    ...
    readyToStart: 'Klaar om te oefenen met {name}',
  ...
  ru: {
    ...
    readyToStart: 'Готовы практиковаться с {name}',
  ...
  fr: {
    ...
    readyToStart: 'Prêt à pratiquer avec {name}',
  ...
  es: {
    ...
    readyToStart: 'Listo para practicar con {name}',
  ...
  de: {
    ...
    readyToStart: 'Bereit zum Üben mit {name}',
